 ...
 * @author Sachintha
 */
public class Map_Tools extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Map_Tools.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

 ...
 * @author Sachintha
 */
public class Map_Proj_Tool extends javax.swing.JFrame {

    /**
     * Creates new form Tool_Search
     */
    public Map_Proj_Tool() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Pro.ID", "Pro.Name", "Tools ID", "Tool Name", "Quantity", "Stores Location"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Map_Proj_Tool.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Map_Proj_Tool().setVisible(true);
            }
        });
    }
